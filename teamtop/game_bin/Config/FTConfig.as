package
{
	...
	public class FTConfig extends Sprite
	{
		...
		[Embed(source = 'ClientConfig/FT_language.txt',mimeType = "application/octet-stream")]
		public var LanguageConfig:Class;
		[Embed(source = 'ClientConfig/color_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Mount/MountIllusion_ft.txt',mimeType = "application/octet-stream")]
		...
		//任务 	MainTask
		[Embed(source = 'Task/MainTask_ft.txt',mimeType = "application/octet-stream")]
		public var MainTask:Class;
		[Embed(source = 'Task/TaskFightReward_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'WonderfulAct/WonderfulAct_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'WonderfulAct/WonderfulReward_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Activity/ActivityTime_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'QQHZ/QQHZnovice_ft.txt',mimeType = "application/octet-stream")]
		public var QQHZnovice:Class;

		[Embed(source = 'QQHZ/QQHZlevel_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'QQHZ/DailyReward_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Pet/PetBase_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Pet/PetEvolution_ft.txt',mimeType = "application/octet-stream")]
		...
		//游戏更新公告表
		[Embed(source = 'ClientConfig/TXT/GongGaoConfig/GongGaoCfg_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/CircularActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/UniversalBuy_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/BraveHeroActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/HaoqiActive_ft.txt',mimeType = "application/octet-stream")]
		public var HaoqiActive:Class;
		[Embed(source = 'GroupBuyCarnival/GroupBuyCarnival_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'DoubleEleven/SeckillBase_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/RichRankActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/ChristmasHaoActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/NewYearHaoActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/LanternFestivalActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/RedEnvelopeActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/LianChongRebateActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'ShenWangBaoKu/ShiJianKongZhi_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/QingMingRankActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'QingMing/QingMingSevenDayRecharge_ft.txt',mimeType = "application/octet-stream")]
		public var QingMingSevenDayRecharge:Class;
		[Embed(source = 'QingMing/QingMingSevenDayConsume_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/ZaiXianJiangLiActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'RewardBuff/RewardBuff_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'WangZheGongCe/WangZheKuaFuRank_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/WangZheRankActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'PassionAct/PassionLoginGift_ft.txt',mimeType = "application/octet-stream")]
		public var PassionLoginGift:Class;
		[Embed(source = 'PassionAct/PassionXiaoFeiMaiDan_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'DoubleEleven/DEQiangHongBaoControl_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'DoubleEleven/ElevenPointControl_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'PassionAct/PassionShouChong_ft.txt',mimeType = "application/octet-stream")]
		public var PassionShouChong:Class;
		[Embed(source = 'PassionAct/PassionTJHCControl_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'DeepHell/DeepHellActive_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'PassionActDoubleTwelve/GruopBuyControl_ft.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CatchingFish/CatchingFishActive_ft.txt',mimeType = "application/octet-stream")]
