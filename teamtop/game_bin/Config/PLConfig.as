package
{
	...
	public class PLConfig extends Sprite
	{
		...
		[Embed(source = 'Union/UnionExploreQuestion_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'UnionKuaFuWar/UnionKuaFuWarTime_pl.txt',mimeType = "application/octet-stream")]
		...
		//任务 	MainTask
		[Embed(source = 'Task/MainTask_pl.txt',mimeType = "application/octet-stream")]
		...
		//支线任务
		[Embed(source = 'Task/SubTask_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'exam/examLib_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Shop/Mall_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Wing/WingBase_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'Title/Title_pl.txt',mimeType = "application/octet-stream")]
		...
		//游戏更新公告表
		[Embed(source = 'ClientConfig/TXT/GongGaoConfig/GongGaoCfg_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/CircularActive_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/BraveHeroActive_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'DragonStele/DragonSteleReward_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/LianChongRebateActive_pl.txt',mimeType = "application/octet-stream")]
		...
		[Embed(source = 'CircularActive/ZaiXianJiangLiActive_pl.txt',mimeType = "application/octet-stream")]
