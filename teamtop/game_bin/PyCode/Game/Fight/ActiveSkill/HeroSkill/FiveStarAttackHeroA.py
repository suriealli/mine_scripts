#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.ActiveSkill.HeroSkill.FiveStarAttackHeroA")
#===============================================================================
# 观音技能 攻击敌方全体目标，忽视目标防御
#===============================================================================
from Game.Fight import SkillBase

class FiveStarAttackHeroA(SkillBase.ActiveSkillBase):
	skill_id = 225			#技能ID
	skill_rate = 0.9	#技能系数（1是平衡点）
	cd_round = 3			#CD回合数
	need_moral = 0		#需要士气
