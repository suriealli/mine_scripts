#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.ActiveSkill.HeroSkill.FourStarAuxiliaryHero")
#===============================================================================
# 四星辅将主动技能 治疗我方全体单位，且全部单位获得一个持续治疗的BUFF
# 英雄技能的ID从200开始
#===============================================================================
from Game.Fight import SkillBase

class FourStarAuxiliaryHero(SkillBase.ActiveSkillBase):
	skill_id = 214			#技能ID
