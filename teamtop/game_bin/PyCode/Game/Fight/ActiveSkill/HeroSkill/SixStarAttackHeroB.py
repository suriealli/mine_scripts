#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.ActiveSkill.HeroSkill.SixStarAttackHeroB")
#===============================================================================
# 六星攻将技能B 攻击敌方两个后排排随机单体目标，并有大概率造成2倍伤害
# 英雄技能的ID从200开始
#===============================================================================
import random
from Game.Fight import SkillBase, Operate

class SixStarAttackHeroB(SkillBase.ActiveSkillBase):
	skill_id = 219			#技能ID
	skill_rate = 1.7		#技能系数（1是平衡点）
