#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.ActiveSkill.HeroSkill.ThreeStarAuxiliaryHero")
#===============================================================================
# 三星辅将主动技能 给己方全体单位增加一个有时效的保护罩
# 英雄技能的ID从200开始
#===============================================================================
from Game.Fight import SkillBase

class ThreeStarAuxiliaryHero(SkillBase.ActiveSkillBase):
	skill_id = 210			#技能ID
	skill_rate = 0.42		#技能系数（1是平衡点）
