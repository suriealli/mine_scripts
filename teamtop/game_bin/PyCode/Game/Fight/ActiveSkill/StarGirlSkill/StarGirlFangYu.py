#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.ActiveSkill.StarGirlSkill.StarGirlFangYu")
#===============================================================================
# 随机给一个英雄或主角增加一个吸收护盾，多个护盾效果独立计算——处女座
#===============================================================================
import random
...
class StarGirlFangYu(StarGirlBase.StarGirlBase):
	skill_id = 3200			#技能ID
	...
	level_to_value = [0, 8000, 9000, 10000, 11000, 12000, 13000, 14000]
