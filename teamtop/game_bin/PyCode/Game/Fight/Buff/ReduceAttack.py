#!/usr/bin/env python
# -*- coding:UTF-8 -*-
# XRLAM("Game.Fight.Buff.ReduceAttack")
#===============================================================================
# 降低攻击
#===============================================================================
from Game.Fight import BuffEx

class ReduceAttack(BuffEx.StateBuff):
	buff_id = 4
	is_benefit = False
	...
	def __init__(self, unit, life, argv):
		...
		if self.be_merge:
			return
		self.reduce_attack = int(self.unit.attack * self.argv)
		self.unit.change_attack(-self.reduce_attack)
	...
	# 删除之前调用的函数
	def before_del(self):
		self.unit.attack += self.reduce_attack
