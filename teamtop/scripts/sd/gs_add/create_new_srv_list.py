...
def Parser_args():
    ...
    help = "Use this argument to specify the Num you want to set./这个参数用来设置的要部署的区的数量"
    ...
    help = "Use this argument to specify the pass_id_list./这个参数用来设置被跳过的id列表，空格隔开"
    parse.add_argument("-P","--pass-id",default = "[]", nargs = '*',help=help)

    help = "Use this argument to specify the host./这个参数用来设置所在的服务器(全部)，格式为“z正式4”"
    ...
    help = "Use this argument to specify the prefix name./这个参数用来设置\033[40;31m第一个\033[0m服角色名称前缀(自增),如不设置，则为sID."
